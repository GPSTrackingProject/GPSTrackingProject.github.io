...
<body>
<div id="w">
<form id="thongtinform" name="thongtinform" method="post" action="thongtin_user.php">
  ...
  <div class="row">
    ...
    <input type="text" name="pass_new" id="pass_new" class="txt" tabindex="3" placeholder="Tài khoản mà bạn muốn đổi" required>
  </div>
   <div class="center">
